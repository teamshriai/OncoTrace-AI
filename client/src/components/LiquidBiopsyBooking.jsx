...
const PRIMARY_INTERESTS = [
  ...
  'VAF / Tumor Fraction Analysis',
  'Clinical Significance Annotation (ClinVar)',
  'Actionability Matching (CIViC)',
  'Variant Tiering & Prioritization',
  'Multi-Caller VCF Support (VarDict / Mutect2 / Strelka2 / DRAGEN)',
  'QC & Sequencing-Artifact Detection',
  'Panel Design / Gene Coverage',
  'Lab / Pipeline Integration',
  'Research & Clinical Trials',
  'Other',
]

const ROLES = [
  'Oncologist', 'Molecular Pathologist', 'Genetic Counselor', 'Clinical Lab Director',
  'Bioinformatician', 'Research Scientist', 'Hospital Administrator', 'Clinical Data Analyst', 'Other',
]
...
function SuccessScreen({ onBack }) {
  return (
    <div
      ...
      style={{
        minHeight: '100vh',
        background: 'linear-gradient(135deg, #eff6ff 0%, #fafafa 50%, #ecfeff 100%)',
    ...
    >
      ...
      <div style={{ position: 'fixed', bottom: '-100px', left: '-60px', width: '340px', height: '340px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(6,182,212,0.05) 0%, transparent 70%)', pointerEvents: 'none' }} />

      <div style={{
        position: 'fixed', top: 0, left: 0, right: 0, height: '3px', zIndex: 50,
        background: 'linear-gradient(90deg, #1d4ed8, #2563eb, #7dd3fc, #2563eb, #1d4ed8)',
      ...
      >
        ...
        <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '14.5px', color: '#6b7280', fontWeight: 400, lineHeight: 1.65, margin: '0 0 6px' }}>
          Our <span style={{ color: '#2563eb', fontWeight: 500 }}>OncoTrace-AI Liquid Biopsy</span> team has received your demo request and will be in touch shortly to explore how our variant-analysis pipeline can support your workflow.
        </p>
...
// ── Main Component ─────────────────────────────────────────────────────────────
export default function LiquidBiopsyBooking({ onBack }) {
    ...
    try {
      await emailjs.send(
        ...
        TEMPLATE_ID,
        {
          ...
          product: 'OncoTrace-AI Liquid Biopsy – ctDNA Variant Analysis',
        },
        PUBLIC_KEY
      )
      setSubmitted(true)
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          minHeight: '100vh',
          background: 'linear-gradient(145deg, #eff6ff 0%, #f8fafc 40%, #ecfeff 80%, #fafafa 100%)',
          position: 'relative',
          overflowX: 'hidden',
        }}
      >
        ...
        <div style={{ position: 'fixed', bottom: '-120px', left: '-80px', width: '420px', height: '420px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(6,182,212,0.05) 0%, transparent 68%)', pointerEvents: 'none', zIndex: 0 }} />
        <div style={{ position: 'fixed', top: '40%', left: '50%', transform: 'translate(-50%,-50%)', width: '700px', height: '400px', borderRadius: '50%', background: 'radial-gradient(ellipse, rgba(191,219,254,0.06) 0%, transparent 70%)', pointerEvents: 'none', zIndex: 0 }} />
        ...
        <nav style={{
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 32px', height: '58px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <div style={{ fontFamily: 'Inter, sans-serif', fontSize: '15.5px', fontWeight: 700, color: '#111827', letterSpacing: '-0.015em', userSelect: 'none' }}>
              OncoTrace<span style={{ color: '#2563eb' }}>-AI</span><span style={{ fontWeight: 300, color: '#94a3b8' }}> · Liquid Biopsy</span>
            </div>

            <div style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
              <div style={{ width: '7px', height: '7px', borderRadius: '50%', background: '#22c55e', animation: 'lb-pulse-dot 2.2s infinite' }} />
              <span style={{ fontFamily: 'Inter, sans-serif', fontSize: '12px', fontWeight: 500, color: '#6b7280' }}>Research Prototype</span>
            </div>
          </div>
        </nav>
        ...
        <main style={{ position: 'relative', zIndex: 1, maxWidth: '1280px', margin: '0 auto', padding: '52px 32px 80px' }}>
          ...
          <div style={{ marginBottom: '40px', animation: 'lb-fade-up 0.55s ease both' }}>
            <div style={{
              ...
              <span style={{ fontFamily: 'Inter, sans-serif', fontSize: '11px', fontWeight: 600, color: '#1e40af', letterSpacing: '0.07em', textTransform: 'uppercase' }}>
                AI-Powered Liquid Biopsy Analysis
              </span>
            </div>
            ...
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: '#64748b', fontWeight: 400, lineHeight: 1.68, margin: 0, maxWidth: '560px' }}>
              See how OncoTrace-AI turns an uploaded ctDNA VCF into a structured, evidence-linked variant report — real ClinVar/CIViC annotation, transparent tiering, and no fabricated risk scores — configured for your clinical or research workflow.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '7px', marginBottom: '30px', paddingBottom: '24px', borderBottom: '1px solid rgba(226,232,240,0.5)' }}>
                {[
                  { label: 'Variant Annotation', icon: <Ic.Zap size={11} /> },
                  { label: 'VAF Quantification', icon: <Ic.Scan size={11} /> },
                  { label: 'ClinVar / CIViC Matching', icon: <Ic.Eye size={11} /> },
                  { label: 'Tiered Classification', icon: <Ic.Activity size={11} /> },
                  { label: 'Multi-Caller Support', icon: <Ic.Shield size={11} /> },
                  { label: 'Structured Reporting', icon: <Ic.BarChart size={11} /> },
                ].map((f, i) => (
                  <span
                    key={i}
                    style={{
                ...
                <div style={{ marginBottom: '22px' }}>
                  <Field label="Goals / Notes">
                    <textarea
                      ...
                      placeholder="Tell us about your sequencing pipeline, variant callers in use, sample volumes, or any specific questions — we'll tailor the demo accordingly."
                ...
                >
                  <label style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', cursor: 'pointer' }} htmlFor="lb-consent">
                    ...
                    <span style={{ fontFamily: 'Inter, sans-serif', fontSize: '12.5px', color: '#4b5563', lineHeight: 1.6, fontWeight: 400 }}>
                      ...
                      <span style={{ color: '#2563eb', fontWeight: 500 }}>OncoTrace-AI Liquid Biopsy</span>{' '}
            ...
            >
              ...
              <div style={{ ...glassCardSubtle, borderRadius: '15px', padding: '22px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '13px' }}>
                  {[
                    ...
                    { icon: <Ic.Scan size={14} />, title: 'Personalised demo', sub: 'Tailored to your VCF pipeline' },
                    { icon: <Ic.Users size={14} />, title: 'Expert Q&A', sub: 'Direct access to the team behind the pipeline' },
              ...
              <div style={{ ...glassCardSubtle, borderRadius: '15px', padding: '22px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '9px' }}>
                  {[
                    'Multi-caller VCF parsing (VarDict, Mutect2, Strelka2, DRAGEN)',
                    'Local ClinVar + CIViC annotation, no third-party API calls',
                    'Disclosed, auditable tiering — not a black-box score',
                    'QC & sequencing-artifact detection',
                    'Germline vs. somatic pattern detection',
                    'Reference build auto-detection (GRCh37 / GRCh38)',
                    'Panel mutation density estimation',
                    'No file retention after analysis',
                    'Research / pilot-use framing throughout',
                  ].map((f, i) => (
              ...
              <div className="lb-sidebar-bottom" style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <div style={{
                  ...
                  {[
                    { icon: <Ic.Lock size={12} />, text: 'Encrypted in transit' },
                ...
                <div style={{
                  ...
                  <div style={{ fontFamily: 'Inter, sans-serif', fontSize: '11.5px', fontWeight: 600, color: '#1e40af', marginBottom: '3px' }}>
